...
tfp.set_lhcb_style(size=5, usetex=False)
...
tfn.estimate_density(
    ...
    labels=titles,
    learning_rate=0.0005,  # Tunable meta-parameter
    weight_penalty=0.005,  # Tunable meta-parameter (larger for smoother distribution)
    ...
    norm_size=8000000,  # Size of the normalisation sample
    ...
    outfile="eff_train",  # Name prefix for output files (.pdf, .npy, .txt)
    seed=4,  # Random seed
